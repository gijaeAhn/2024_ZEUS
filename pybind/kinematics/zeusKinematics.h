...
std::vector<double> ARM6_kinematics_inverse_iterative_arm(Transform trArm, const double *qOrg);
std::vector<double> ARM6_kinematics_inverse_arm(Transform trArm, const std::vector<double> qOrg );
