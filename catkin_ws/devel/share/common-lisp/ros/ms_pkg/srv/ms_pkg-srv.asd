...
(defsystem "ms_pkg-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "Greeting_service" :depends-on ("_package_Greeting_service"))
    (:file "_package_Greeting_service" :depends-on ("_package"))
    (:file "IC_service" :depends-on ("_package_IC_service"))
    (:file "_package_IC_service" :depends-on ("_package"))
