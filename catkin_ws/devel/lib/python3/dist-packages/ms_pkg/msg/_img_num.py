...
"""autogenerated by genpy from ms_pkg/img_num.msg. Do not edit."""
import codecs
import sys
...
class img_num(genpy.Message):
  _md5sum = "f03678201ea54f45ff6f4b17e7685f68"
  _type = "ms_pkg/img_num"
...
string frame_id
"""
  __slots__ = ['img','msg_seq']
  _slot_types = ['sensor_msgs/Image','uint16']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(img_num, self).__init__(*args, **kwds)
