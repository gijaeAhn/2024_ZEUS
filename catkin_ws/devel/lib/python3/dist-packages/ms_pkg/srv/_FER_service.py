...
"""autogenerated by genpy from ms_pkg/FER_serviceRequest.msg. Do not edit."""
import codecs
import sys
...
class FER_serviceRequest(genpy.Message):
  _md5sum = "b4274f524cc812fc54ca8ebeeda2deb2"
  _type = "ms_pkg/FER_serviceRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FER_serviceRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ms_pkg/FER_serviceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class FER_serviceResponse(genpy.Message):
  _md5sum = "db954e5de3aba73b237d07575e5cac28"
  _type = "ms_pkg/FER_serviceResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FER_serviceResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_f():
    ...
    return _struct_f
class FER_service(object):
  _type          = 'ms_pkg/FER_service'
  _md5sum = '7265aed7a01c523a6d802a58fa938c44'
  _request_class  = FER_serviceRequest
  _response_class = FER_serviceResponse
